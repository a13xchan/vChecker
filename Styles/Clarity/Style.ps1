...
# Header Images
Add-ReportResource "Header-vCheck" ($StylePath + "\orig_Header.jpg") -Used $true
...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <div>&nbsp;</div>
   <footer>
      <p>vSphereChecker v$($vCheckVersion) by <a href='http://virtualfrog.wordpress.com'>Dario Doerflinger</a> generated on $($ENV:Computername) on $($Date.ToLongDateString()) at $($Date.ToLongTimeString())</p>
   </footer>
   </div>
   </body>
</html>
